 ...
 */
	...
	{
		parent::beforeFilter();
		//solo permite anadir sii no a entrado 		
		$this->Auth->allow('add');
	...
	public function login()
	{
		if($this->request->is('post'))
		{
			...
			$this->Session->setFlash('AL PARCER TUS DATOS SON INORRECTOS, POR FAVOR INGRESALOS DE NUEVO!', 'default', array('class' => 'alert alert-danger'));
		}
	}
	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->User->save($this->request->data)) {
				$this->Session->setFlash('TUS DATOS HAN SIDO GUARDADOS Y TU CUENTA SE HA CREADO.', 'default', array('class' => 'alert alert-success'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('LO SENTIMOS, INTENTA REGISTRARTE DE NUEVO.', 'default', array('class' => 'alert alert-danger'));
			}
		}
	}
/**
